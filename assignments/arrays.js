...
let lastCar = 0;
let ind = inventory.length - 1;

console.log(
  `last car is ${inventory[ind].car_make} ${inventory[ind].car_model}`
);
...
let oldCars = [];
oldCars = carYears.filter(function(i) {
  return i < 2000;
});
...
let stringified = JSON.stringify(BMWAndAudi);

console.log(stringified);

//challenge 6 with filter 
var germancars = inventory.filter(function(i){return i.car_make ==="Audi" || i.car_make=="BMW"} );
